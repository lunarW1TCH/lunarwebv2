---
id: rest-api-performance
description: A project in which I created 5 REST API clients in different technologies and compared their performance.
technologies:
  - rust
  - rocket
  - elixir
...
It might work great for bigger projects but for this experiment it was an overkill.../../components/mdx/index.ts
